...
## Documentation for Function setLtime_of_day32 (BOOL)  

```pascal
INTERFACE
    VAR_INPUT
        ix : USINT; (*Index to write*)
        value : LTIME_OF_DAY; (*Value to set to the index*)
    END_VAR
    VAR_IN_OUT
        data : LTIME_OF_DAY32; (*Data to work on*)
    END_VAR
END_INTERFACE
FUNCTION setLtime_of_day32 :
    CASE ix OF
...
ELSE
	...
	setLtime_of_day32 := FALSE;
	RETURN;
END_CASE
setLtime_of_day32 := TRUE;
RETURN;
