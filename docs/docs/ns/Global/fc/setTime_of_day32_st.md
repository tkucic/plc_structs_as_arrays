...
## Documentation for Function setTime_of_day32 (BOOL)  
...
INTERFACE
    ...
    VAR_INPUT 
        ...
        value : TOD; (*Value to set to the index*)
    END_VAR
END_INTERFACE
FUNCTION setTime_of_day32 :
    CASE ix OF
    ...
    ELSE
    	...
    	setTime_of_day32 := FALSE;
    	RETURN;
    END_CASE
    setTime_of_day32 := TRUE;
    RETURN;
