...
## Documentation for Function setDate_and_time32 (BOOL)  
...
INTERFACE
    ...
    VAR_INPUT 
        ...
        value : DT; (*Value to set to the index*)
    END_VAR
END_INTERFACE
FUNCTION setDate_and_time32 :
    CASE ix OF
    ...
    ELSE
    	...
    	setDate_and_time32 := FALSE;
    	RETURN;
    END_CASE
    setDate_and_time32 := TRUE;
    RETURN;
